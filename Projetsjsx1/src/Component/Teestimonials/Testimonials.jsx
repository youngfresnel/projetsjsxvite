...
const TestimonialData = [
  ...
  },
  {
    id: 2,
    name: "Satya Nadella",
    text: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Eaque<br/>reiciendis inventore iste ratione ex alias quis magni at optio",
            ...
            {/* hearder section  */}
              <div className='text-center mb-10 max-w-[600px] mx-auto'>
                    <p  data-aos='fade-up' className='text-sm text-primary'>
                      Quelles sont les questions des clients
                    </p>
                      ...
                      {TestimonialData.map((data) => (
                        <div className='my-6'>
                          ...
                          key={data.id}
                            ...
                            py-8 px-6 mx-6 rounded-xl dark:bg-gray-800 
