...
const Phoneconnection = () => {
  return (
        <div className="">
        <div className="flex ">
            <InputComponent labelone="Telephone" placeone="Enter your adress email" isHrere={true} labeltwo="Password" placetwo="Entrer your password"/>
        </div>
...
export default memo(Phoneconnection)